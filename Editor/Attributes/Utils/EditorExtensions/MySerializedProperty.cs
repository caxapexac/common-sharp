...
namespace Caxapexac.Common.Sharp.Editor.Attributes.Utils.EditorExtensions
{
    public static class MySerializedProperty
    {
        ...
        public static SerializedProperty[] AsArray(this SerializedProperty property)
        {
            ...
            for (int i = 0; i < property.arraySize; i++) items.Add(property.GetArrayElementAtIndex(i));
        ...
        {
            for (int i = 0; i < property.arraySize; i++) yield return property.GetArrayElementAtIndex(i);
        }
