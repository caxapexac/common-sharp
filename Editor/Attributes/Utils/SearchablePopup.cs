...
namespace Caxapexac.Common.Sharp.Editor.Attributes.Utils
{
    ...
    public class SearchablePopup : PopupWindowContent
    {
        ...
        {
            if (Event.current.type == EventType.Repaint) EditorStyles.toolbar.Draw(rect, false, false, false, false);
        ...
        private void DrawSelectionArea(Rect scrollRect)
        {
            ...
            for (int i = 0; i < list.Entries.Count; i++)
            {
                ...
                {
                    if (Event.current.type == EventType.MouseMove || Event.current.type == EventType.ScrollWheel) hoverIndex = i;
        ...
        private void DrawRow(Rect rowRect, int i)
        {
            ...
            else if (i == hoverIndex) DrawBox(rowRect, Color.white);
