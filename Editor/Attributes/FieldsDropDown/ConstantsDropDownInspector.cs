...
{
    [CustomPropertyDrawer(typeof(ConstantsDropDownAttribute))]
    public class ConstantsDropDownInspector : PropertyDrawer
    {
        private ConstantsDropDownAttribute _attribute;
        ...
        {
            _attribute = (ConstantsDropDownAttribute)attribute;
            ...
            {
                if ((field.IsInitOnly || field.IsLiteral) && field.FieldType == _targetType) _constants.Add(field);
            }
            ...
            if (currentValue != null)
            {
                ...
                {
                    if (!currentValue.Equals(_values[i])) continue;
                    _valueFound = true;
