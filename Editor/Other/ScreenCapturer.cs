...
namespace Caxapexac.Common.Sharp.Editor.Other
{
    ...
    sealed class ScreenCapturer : MonoBehaviour
    {
        ...
        static class GameViewResolution
        {
            ...
            {
                var gvType = typeof(LeopotamGroup.EditorHelpers.Editor).Assembly.GetType("UnityEditor.GameView");
                ...
                var gvgType = typeof(LeopotamGroup.EditorHelpers.Editor).Assembly.GetType("UnityEditor.GameViewSizeGroup");
                ...
                var sizesType = typeof(LeopotamGroup.EditorHelpers.Editor).Assembly.GetType("UnityEditor.GameViewSizes");
                ...
                var gvsType = typeof(LeopotamGroup.EditorHelpers.Editor).Assembly.GetType("UnityEditor.GameViewSize");
