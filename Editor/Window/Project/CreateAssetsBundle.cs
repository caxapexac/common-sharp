...
namespace Caxapexac.Common.Sharp.Editor.Window.Project
{
    ...
    internal sealed class CreateAssetsBundle : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox("Note: if you will load bundle directly from disk – choose option \"UncompressedAssetBundle\", to pack bundle and download from remote source – choose \"None\".",
