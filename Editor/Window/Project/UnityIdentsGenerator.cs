...
namespace Caxapexac.Common.Sharp.Editor.Window.Project
{
    ...
    internal class UnityIdentsGenerator : EditorWindow
    {
        ...
        [MenuItem("Tools/Common/Unity Idents Generator")]
        ...
        private static string GenerateFields(string indent, GenerationSettings settings)
        {
            ...
            var ignoredPaths = string.IsNullOrEmpty(settings.IgnoredPaths) ? new string[0] : settings.IgnoredPaths.Split(new char[] {';'}, StringSplitOptions.RemoveEmptyEntries);
