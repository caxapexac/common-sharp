...
namespace Caxapexac.Common.Sharp.MathExtra
{
    ...
    public sealed class RngFast
    {
        ...
        public int GetInt(int min, int max)
        {
            ...
            _y = _z;
            _z = _w;
            return min + (int)((InvMaxIntExOne * (int)(0x7fffffff & (_w = (_w ^ (_w >> 19)) ^ (t ^ (t >> 8))))) * (max - min));
        }
        ...
        public float GetFloat(bool includeOne = true)
        {
            ...
            _y = _z;
            _z = _w;
            return (float)((includeOne ? InvIntMax : InvMaxIntExOne) * (int)(0x7fffffff & (_w = (_w ^ (_w >> 19)) ^ (t ^ (t >> 8)))));
        }
        ...
        public float GetFloat(float min, float max, bool includeMax = true)
        {
            ...
            _y = _z;
            _z = _w;
            return min + (float)((includeMax ? InvIntMax : InvMaxIntExOne) * (int)(0x7fffffff & (_w = (_w ^ (_w >> 19)) ^ (t ^ (t >> 8)))) * (max - min));
        }
    }
}